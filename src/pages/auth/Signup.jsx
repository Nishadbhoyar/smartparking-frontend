...
// import { User, Mail, Phone, Lock, Car, Building2, MapPin, ArrowRight, Loader2 } from "lucide-react";
...
//           <h1 className="text-4xl font-black bg-gradient-to-r from-indigo-300 to-purple-300 bg-clip-text text-transparent tracking-tight">
//             SmartPark
//           </h1>
...
//             >
//               <field.icon className="absolute left-4 top-3.5 text-indigo-200 group-focus-within:text-white transition-colors w-5 h-5" />
//               <input
//                 type={field.type}
//                 name={field.name}
...
//                 className="w-full pl-12 pr-4 py-3 bg-white/10 border border-white/10 rounded-xl text-sm focus:ring-2 focus:ring-indigo-400 focus:bg-white/20 outline-none text-white placeholder-indigo-200/50 transition-all"
//                 required
//               />
//             </motion.div>
//           ))}
...
//             <label className="block text-xs font-bold text-indigo-200 uppercase mb-3 text-center">
//               Select Role
//             </label>
...
//                     animate={{
//                       backgroundColor:
//                         formData.role === r.value ? "#4f46e5" : "rgba(255,255,255,0.1)",
//                       color: formData.role === r.value ? "#ffffff" : "#e0e7ff",
//                       borderColor:
//                         formData.role === r.value ? "#4f46e5" : "rgba(255,255,255,0.2)",
//                     }}
...
//             type="submit"
//             disabled={loading}
//             className="w-full bg-gradient-to-r from-indigo-600 to-purple-600 text-white font-bold py-3.5 rounded-xl shadow-lg hover:shadow-indigo-500/30 transition-all flex items-center justify-center gap-2 relative overflow-hidden"
//           >
//             {loading ? (
