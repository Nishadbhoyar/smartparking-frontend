...
function ValetDashboard() {
  ...
  const handleLogout = async () => {
    try {
      const config = getAuthConfig();
      if (config) await axios.post("http://localhost:https://smartparking-backend-1.onrender.com/api/auth/logout", {}, config);
  ...
  const handleAccept = async (booking) => {
    ...
    if (!config) return;
    try {
      await axios.post(`http://localhost:https://smartparking-backend-1.onrender.com/api/bookings/${booking.id}/pickup`, {}, config);
      setActiveTask(booking);
      fetchQueue();
  ...
  const handleSubmitCompletion = async () => {
    ...
    try {
      ...
      await axios.post(`http://localhost:https://smartparking-backend-1.onrender.com/api/bookings/${activeTask.id}/complete`, formData, {
