// Updated ValetNavbar.jsx - Simplified for consistency
import { useState, useEffect } from "react";
import { NavLink, useNavigate, useLocation } from "react-router-dom";
import { Navigation, Home, LogOut, Menu, X } from "lucide-react";
      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="flex items-center justify-between">
          ...
          >
            ...
            <span className="text-xl font-bold text-slate-800">Valet<span className="text-transparent bg-gradient-to-r from-blue-600 to-indigo-600 bg-clip-text">Service</span></span>
          </div>

          {/* DESKTOP NAV */}
          <div className="hidden md:flex items-center gap-4">
            <NavItem to="/valet-dashboard">
        ...
        {isOpen && (
          <div className="md:hidden mt-4 bg-white rounded-xl border border-slate-200 shadow-xl p-4 animate-slide-down">
            <MobileNavItem to="/valet-dashboard" icon={<Home className="w-5 h-5" />}>
              Dashboard
            </MobileNavItem>
            <button
              onClick={handleLogout}
